...
<%@ Register Assembly="DevExpress.Web.ASPxSpellChecker.v14.1, Version=14.1.15.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxSpellChecker" TagPrefix="dxwsc" %>
...
<%@ Control Language="vb" AutoEventWireup="true" Codebehind="SpellCheckForm.ascx.vb" Inherits="SpellCheckForm" %>
